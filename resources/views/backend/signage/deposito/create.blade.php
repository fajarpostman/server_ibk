@extends('layouts.app')
@section('title_page', ucfirst(__('backend.add') . ' ' . __('backend.deposito')))
@section('description_page', ucfirst( __('backend.add') . ' new ' . __('backend.deposito')))
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="form-group">
                    {!! Form::open(['route' => 'signage.deposito.store', 'method' => 'post']) !!}
                    <div class="row">
                        <div class="col-xs-4">
                            <label for="tenor">Tenor</label>
                            {{ Form::text('tenor', null, [
                                    'class' => 'form-control',
                                    'id' => 'tenor',
                                    'placeholder' => 'Tenor',
                                ]) }}
