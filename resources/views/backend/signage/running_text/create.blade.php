@extends('layouts.app')
@section('title_page', ucfirst(__('backend.add') . ' ' . __('backend.running_text')))
@section('description_page', ucfirst( __('backend.add') . ' ' . __('backend.running_text')))
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{ ucfirst(__('backend.add') . ' ' . __('backend.running_text')) }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="form-group">
                    {!! Form::open(['route' => 'signage.running-text.store', 'method' => 'post']) !!}
                    <div class="row">
                        <div class="col-xs-3">
                            <label for="text">@lang('backend.running_text_page.text')</label>
                            {{ Form::text('text', null, [
                                'class' => 'form-control',
                                'id' => 'text',
...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{ ucfirst(__('backend.add') . ' ' . __('backend.running_text')) }} &nbsp;<input id="check-all" type="checkbox" name="branch[]" class="flat-red"></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="form-group">
