@extends('layouts.app')
@section('title_page', ucfirst(__('backend.edit') . ' ' . __('backend.device')))
@section('description_page', ucfirst( __('backend.edit') . ' new ' . __('backend.device')))
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{ ucfirst(__('backend.edit') . ' ' . __('backend.device')) }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="form-group">
                    {!! Form::open(['route' => ['master.device.update', $device->id], 'method' => 'patch']) !!}
                    <div class="row">
                        <div class="col-xs-4">
                            <label for="branch">@lang('backend.device_page.branch')</label>
                            {{ Form::select('branch', $branch, $device->location_id,[
                        ...
                        <div class="col-xs-4">
                            ...
                            {{ Form::text('device', $device->device, [
                                    'class' => 'form-control',
                                    'id' => 'device',
                        ...
                        <div class="col-xs-4">
                            ...
                            {{ Form::text('ip_address', $device->ip_address, [
                                'class' => 'form-control',
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            {{ Form::text('location', $device->location, [
                                    'class' => 'form-control',
                                    'id' => 'location',
